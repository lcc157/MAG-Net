...
tf.app.flags.DEFINE_boolean('RESNET_MAX_POOL', False, "Whether to have weight decay on bias as well")
tf.app.flags.DEFINE_integer('RESNET_FIXED_BLOCKS', 1, "Iteration intervals for showing the loss during training, on command line interface")
#######################
# Training Parameters #
#######################
...
tf.app.flags.DEFINE_integer('max_size', 2000, "Max pixel size of the longest side of a scaled input image")
tf.app.flags.DEFINE_integer('test_max_size', 2000, "Max pixel size of the longest side of a scaled input image")
...
tf.app.flags.DEFINE_integer('rpn_batchsize', 128, "Total number of examples")
...
def get_output_dir(imdb, weights_filename):
    ...
    (if not None).
    """
    outdir = osp.abspath(osp.join(FLAGS2["root_dir"], FLAGS2["root_dir"] , 'default_resnet', imdb.name))
